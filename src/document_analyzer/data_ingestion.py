...
class DocumentHandler:
    ...
    def read_pdf(self, pdf_path:str)->str:
        try:
            ...
            # replaced self.log.error with self.log.exception (from ChatGPT's suggestion in DocumentPortalException)
            # self.log.error(f"Error reading PDF: {e}")
            self.log.exception("Error reading PDF", pdf_path=pdf_path, session_id=self.session_id)
...
if __name__ == "__main__":
    ...
    #pdf_path=r"C:\\Users\\tessd\\DP2026\\document_portal\\data\\document_analysis\\NIPS-2017-attention-is-all-you-need-Paper.pdf"
    pdf_path=r"C:\\Users\\tessd\\DP2026\\document_portal\\data\\document_analysis\\sample.pdf"
    class DummyFile:
