...
class DocumentIngestor:
    ...
    def __init__(self, temp_dir:str = "data/multi_doc_chat",faiss_dir: str = "faiss_index", session_id: str | None = None):
        try:
            ...
            self.log.exception("Failed to initialize DocumentIngestor")
        ...
        try:
            ...
            for uploaded_file in uploaded_files:
                ...
                if ext not in self.SUPPORTED_EXTENSIONS:
                    self.log.warning("Unsupported file skipped", filename=filename)
                    continue
                ...
                self.log.info("File saved for ingestion", filename=filename, saved_as=str(temp_path), session_id=self.session_id)
                ...
                if ext == ".pdf":
                    ...
                    self.log.warning("Unsupported file type encountered", filename=filename)
                    continue
            ...
            self.log.exception("Failed to ingest files")
    ...
    def _create_retriever(self, documents):
        try:
            ...
            self.log.exception("Failed to create retriever")
