...
class ConversationalRAG:
    def __init__(self,session_id:str, retriever=None):
        try:
            ...
            self.log.exception("Failed to initialize ConversationalRAG")
    ...
    def load_retiever_from_faiss(self,index_path: str):
        ...
        try:
            ...
            self.log.exception("Failed to load retriever from FAISS")
    ...
    def invoke(self,user_input:str,chat_history: Optional[List[BaseMessage]] = None) ->str:
        ...
        try:
            ...
            self.log.exception("Failed to invoke ConversationalRAG")
    ...
    def _load_llm(self):
        try:
            ...
            self.log.exception("Failed to load LLM")
    ...
    def _build_lcel_chain(self):
        try:
            ...
            self.log.exception("Failed to build LCEL chain", session_id=self.session_id)
